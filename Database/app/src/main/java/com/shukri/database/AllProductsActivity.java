...
public class AllProductsActivity extends ListActivity {
    ...
    private static String url_all_products = "http://classdays.x10host.com/get_all_products.php";
    ...
    private static final String TAG_PROF = "professor";
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            AllProductsActivity.this, classesList,
                            R.layout.list_item, new String[] { TAG_PID,
                            TAG_NAME,TAG_PROF},
                            new int[] { R.id.pid, R.id.name,R.id.prof });
                    // updating listview
